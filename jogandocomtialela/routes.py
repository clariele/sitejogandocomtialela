...
from jogandocomtialela import app, database, bcrypt
from jogandocomtialela.forms import FormLogin, FormCriarConta, FormEditarPerfil, FormCriarPost
from jogandocomtialela.models import Usuario, Post
...
def login():
    ...
    if form_criarconta.validate_on_submit() and 'botao_submit_criarconta' in request.form:
        ...
        #Adicionando a sessão do banco de dados
        database.session.add(usuario)
        #Dando um commit no usuário
