...
from jogandocomtialela.models import Usuario
...
class FormEditarPerfil(FlaskForm):
    ...
    jogo_cacapalavras = BooleanField('Caça Palavras')
    jogo_pacman = BooleanField('Pac Man')
    jogo_rima = BooleanField('Jogo da Rima')
    jogo_flappybird = BooleanField('Flappy Bird')
